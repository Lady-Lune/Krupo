...
import {Tabs, TabsPanel, Affix, Button, Popover} from '@mantine/core'
...
const MainTabs = () => {
    ...
    <Popover radius={curpage=="helpers"? "xl":"md"}>
        <Popover.Target>
        <Affix bottom={30} right={30}>
            <Button name="gift" p="md" size="xl" radius="xl" color={colors["Moss Green-d1"]}> {/*onClick={open}*/}
