import { Affix, Button, Card, Tabs, TabsPanel, Text, Image, Stack, Group } from '@mantine/core';
...
export default function MainTabs() {
  ...
  return (
    <>
      <Tabs defaultValue="community" variant="pills" radius="xs">
        <Tabs.List grow justify="center" ff="Averia Gruesa Libre">
          <Tabs.Tab value="gift-xchng" color={colors['Dark Skintone-d1']}>
            GIFT EXCHANGE
          </Tabs.Tab>
          <Tabs.Tab value="community" color={colors['Moss Green']}>
            COMMUNITY
          </Tabs.Tab>
          <Tabs.Tab value="helpers" color={colors['Light Skintone']}>
            HELPERS
          </Tabs.Tab>
        </Tabs.List>
          ...
          <Card>
            ...
            <Stack mt="md" mb="xs">
              ...
              <Text size="sm" c={'grape'}  >
                This is a sample card with proper styling and structure. You can customize this further based on your needs.
              </Text>
            </Stack>

            <Group justify="space-between" mt="md">
              <Button variant="light" color="navy" radius="md">
                Learn More
              </Button>
              <Button variant="filled" color="navy" radius="md">
                Get Started
              </Button>
            </Group>
          </Card>
