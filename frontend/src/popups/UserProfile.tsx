...
const UserProfile = ({ opened, onClose, user }: UserProfileProps) => {
    ...
    return (
        <>
        <Modal opened={opened} onClose={onClose} title={user.username} >
        ...
        <Card withBorder>
            ...
            <Group justify="space-between">
                ...
                <Text size="sm">{new Date(user.date_joined).toLocaleDateString()}</Text>
            </Group>
            ...
            <Group>
                ...
                <Anchor href={user.fb_account} target="_blank">Facebook Account</Anchor>
            </Group>
            ...
            <Group>
                ...
                <Anchor href={user.ig_account} target="_blank">Instagram Account</Anchor>
            </Group>
            ...
            <Group>
                ...
                <Anchor href={`mailto:${user.email}`}>Email</Anchor>
            </Group>

            <Space h={20}/>

            <Text c={"red"}>Helper Cards</Text>
            {/* After fiduring out filtering system */}
